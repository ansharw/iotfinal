...
class Model_control extends CI_Model
{
    ...
    {
        $sql = "SELECT suhu, suhu1, suhu2, suhu3, suhu4, suhuLuar, kelembaban, kelembaban1, kelembaban2, kelembaban3, kelembaban4, kelembabanLuar, date_format(waktu, '%Y-%m-%e %H:%i') as waktu FROM SensorData2 ORDER BY waktu DESC LIMIT 10";
